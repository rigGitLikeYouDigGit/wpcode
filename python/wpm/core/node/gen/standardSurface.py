...
if T.TYPE_CHECKING:
	...
	PaintableShadingDependNode = Catalogue.PaintableShadingDependNode
else:
...
class StandardSurface(PaintableShadingDependNode):
	...
	nodeLeafClassAttrs = ["base", "baseColorB", "baseColorG", "baseColorR", "baseColor", "coat", "coatAffectColor", "coatAffectRoughness", "coatAnisotropy", "coatColorB", "coatColorG", "coatColorR", "coatColor", "coatIOR", "coatNormalX", "coatNormalY", "coatNormalZ", "coatNormal", "coatRotation", "coatRoughness", "diffuseRoughness", "emission", "emissionColorB", "emissionColorG", "emissionColorR", "emissionColor", "lightAmbient", "lightBlindData", "lightDiffuse", "lightDirectionX", "lightDirectionY", "lightDirectionZ", "lightDirection", "lightIntensityB", "lightIntensityG", "lightIntensityR", "lightIntensity", "lightShadowFraction", "lightSpecular", "preShadowIntensity", "lightDataArray", "metalness", "normalCameraX", "normalCameraY", "normalCameraZ", "normalCamera", "objectId", "opacityB", "opacityG", "opacityR", "opacity", "outColorB", "outColorG", "outColorR", "outColor", "outTransparencyB", "outTransparencyG", "outTransparencyR", "outTransparency", "pointCameraX", "pointCameraY", "pointCameraZ", "pointCamera", "primitiveId", "rayDepth", "rayDirectionX", "rayDirectionY", "rayDirectionZ", "rayDirection", "rayInstance", "raySampler", "sheen", "sheenColorB", "sheenColorG", "sheenColorR", "sheenColor", "sheenRoughness", "specular", "specularAnisotropy", "specularColorB", "specularColorG", "specularColorR", "specularColor", "specularIOR", "specularRotation", "specularRoughness", "subsurface", "subsurfaceAnisotropy", "subsurfaceColorB", "subsurfaceColorG", "subsurfaceColorR", "subsurfaceColor", "subsurfaceRadiusB", "subsurfaceRadiusG", "subsurfaceRadiusR", "subsurfaceRadius", "subsurfaceScale", "tangentUCameraX", "tangentUCameraY", "tangentUCameraZ", "tangentUCamera", "thinFilmIOR", "thinFilmThickness", "thinWalled", "transmission", "transmissionColorB", "transmissionColorG", "transmissionColorR", "transmissionColor", "transmissionDepth", "transmissionDispersion", "transmissionExtraRoughness", "transmissionScatterB", "transmissionScatterG", "transmissionScatterR", "transmissionScatter", "transmissionScatterAnisotropy", "triangleNormalCameraX", "triangleNormalCameraY", "triangleNormalCameraZ", "triangleNormalCamera"]
	nodeLeafPlugs = ["base", "baseColor", "coat", "coatAffectColor", "coatAffectRoughness", "coatAnisotropy", "coatColor", "coatIOR", "coatNormal", "coatRotation", "coatRoughness", "diffuseRoughness", "emission", "emissionColor", "lightDataArray", "metalness", "normalCamera", "objectId", "opacity", "outColor", "outTransparency", "pointCamera", "primitiveId", "rayDepth", "rayDirection", "rayInstance", "raySampler", "sheen", "sheenColor", "sheenRoughness", "specular", "specularAnisotropy", "specularColor", "specularIOR", "specularRotation", "specularRoughness", "subsurface", "subsurfaceAnisotropy", "subsurfaceColor", "subsurfaceRadius", "subsurfaceScale", "tangentUCamera", "thinFilmIOR", "thinFilmThickness", "thinWalled", "transmission", "transmissionColor", "transmissionDepth", "transmissionDispersion", "transmissionExtraRoughness", "transmissionScatter", "transmissionScatterAnisotropy", "triangleNormalCamera"]
	pass
