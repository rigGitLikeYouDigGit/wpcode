...
class ParticleSamplerInfo(ShadingDependNode):
	...
	nodeLeafClassAttrs = ["accelerationX", "accelerationY", "accelerationZ", "acceleration", "age", "ageNormalized", "birthPositionX", "birthPositionY", "birthPositionZ", "birthPosition", "birthTime", "birthWorldPositionX", "birthWorldPositionY", "birthWorldPositionZ", "birthWorldPosition", "collisionU", "collisionV", "colorBlue", "colorGreen", "colorRed", "finalLifespanPP", "forceX", "forceY", "forceZ", "force", "incandescenceB", "incandescenceG", "incandescenceR", "incandescence", "incandescencePPB", "incandescencePPG", "incandescencePPR", "incandescencePP", "inverseOutUv", "lifespan", "lifespanPP", "normalizationMethod", "normalizationValue", "objectType", "opacity", "opacityPP", "outColorB", "outColorG", "outColorR", "outColor", "outIncandescenceB", "outIncandescenceG", "outIncandescenceR", "outIncandescence", "outTransparencyB", "outTransparencyG", "outTransparencyR", "outTransparency", "outUCoord", "outVCoord", "outUvCoord", "outUvType", "parentU", "parentV", "particleAge", "particleAttrArray", "particleColorB", "particleColorG", "particleColorR", "particleColor", "particleId", "particleIncandescenceB", "particleIncandescenceG", "particleIncandescenceR", "particleIncandescence", "particleLifespan", "particleOrder", "particleTransparencyB", "particleTransparencyG", "particleTransparencyR", "particleTransparency", "positionX", "positionY", "positionZ", "position", "radius", "radiusPP", "bPP", "gPP", "rPP", "rgbPP", "userScalar1PP", "userScalar2PP", "userScalar3PP", "userScalar4PP", "userScalar5PP", "userVector1PPX", "userVector1PPY", "userVector1PPZ", "userVector1PP", "userVector2PPX", "userVector2PPY", "userVector2PPZ", "userVector2PP", "userVector3PPX", "userVector3PPY", "userVector3PPZ", "userVector3PP", "userVector4PPX", "userVector4PPY", "userVector4PPZ", "userVector4PP", "userVector5PPX", "userVector5PPY", "userVector5PPZ", "userVector5PP", "velocityX", "velocityY", "velocityZ", "velocity", "worldPositionX", "worldPositionY", "worldPositionZ", "worldPosition", "worldVelocityX", "worldVelocityY", "worldVelocityZ", "worldVelocity"]
	nodeLeafPlugs = ["acceleration", "age", "ageNormalized", "birthPosition", "birthTime", "birthWorldPosition", "collisionU", "collisionV", "colorBlue", "colorGreen", "colorRed", "finalLifespanPP", "force", "incandescence", "incandescencePP", "inverseOutUv", "lifespan", "lifespanPP", "normalizationMethod", "normalizationValue", "objectType", "opacity", "opacityPP", "outColor", "outIncandescence", "outTransparency", "outUvCoord", "outUvType", "parentU", "parentV", "particleAge", "particleAttrArray", "particleColor", "particleId", "particleIncandescence", "particleLifespan", "particleOrder", "particleTransparency", "position", "radius", "radiusPP", "rgbPP", "userScalar1PP", "userScalar2PP", "userScalar3PP", "userScalar4PP", "userScalar5PP", "userVector1PP", "userVector2PP", "userVector3PP", "userVector4PP", "userVector5PP", "velocity", "worldPosition", "worldVelocity"]
	pass
