...
class NParticle(NBase):
	...
	nodeLeafClassAttrs = ["blobbyRadiusScale", "bounceRandomize", "bounceScale_FloatValue", "bounceScale_Interp", "bounceScale_Position", "bounceScale", "bounceScaleInput", "bounceScaleInputMax", "cacheableAttributes", "collideStrengthScale_FloatValue", "collideStrengthScale_Interp", "collideStrengthScale_Position", "collideStrengthScale", "collideStrengthScaleInput", "collideStrengthScaleInputMax", "collideWidthScale", "color_ColorB", "color_ColorG", "color_ColorR", "color_Color", "color_Interp", "color_Position", "color", "colorBlue", "colorGreen", "colorInput", "colorInputMax", "colorPerVertex", "colorRandomize", "colorRed", "computeRotation", "drag", "emissionOverlapPruning", "enableSPH", "frictionRandomize", "frictionScale_FloatValue", "frictionScale_Interp", "frictionScale_Position", "frictionScale", "frictionScaleInput", "frictionScaleInputMax", "ignoreSolverGravity", "ignoreSolverWind", "incandescence_ColorB", "incandescence_ColorG", "incandescence_ColorR", "incandescence_Color", "incandescence_Interp", "incandescence_Position", "incandescence", "incandescenceInput", "incandescenceInputMax", "incandescencePerVertex", "incandescenceRandomize", "incompressibility", "inputAttract", "inputAttractDamp", "internalBounceRamp", "internalCollideStrengthRamp", "internalColorRamp", "internalFieldScaleRamp", "internalFrictionRamp", "internalIncandescenceRamp", "internalMassRamp", "internalOpacityRamp", "internalRadiusRamp", "internalStickinessRamp", "internalSurfaceTensionRamp", "internalViscosityRamp", "massScale_FloatValue", "massScale_Interp", "massScale_Position", "massScale", "massScaleInput", "massScaleInputMax", "massScaleRandomize", "maxTriangleResolution", "meshMethod", "meshSmoothingIterations", "meshTriangleSize", "motionStreak", "numSubdivisions", "opacity", "opacityPerVertex", "opacityScale_FloatValue", "opacityScale_Interp", "opacityScale_Position", "opacityScale", "opacityScaleInput", "opacityScaleInputMax", "opacityScaleRandomize", "outMesh", "parallelSPH", "pointFieldScale_FloatValue", "pointFieldScale_Interp", "pointFieldScale_Position", "pointFieldScale", "pointFieldScaleInput", "pointFieldScaleInputMax", "postCacheRampEval", "radius", "radiusScale_FloatValue", "radiusScale_Interp", "radiusScale_Position", "radiusScale", "radiusScaleInput", "radiusScaleInputMax", "radiusScaleRandomize", "radiusScaleSPH", "recomputePairsSPH", "restDensity", "rotationDamp", "rotationFriction", "scalingRelation", "selfCollideWidthScale", "solverDisplay", "stickinessRandomize", "stickinessScale_FloatValue", "stickinessScale_Interp", "stickinessScale_Position", "stickinessScale", "stickinessScaleInput", "stickinessScaleInputMax", "surfaceTension", "surfaceTensionScale_FloatValue", "surfaceTensionScale_Interp", "surfaceTensionScale_Position", "surfaceTensionScale", "surfaceTensionScaleInput", "surfaceTensionScaleInputMax", "threshold", "useGradientNormals", "uvwPerVertex", "velocityPerVertex", "viscosity", "viscosityScale_FloatValue", "viscosityScale_Interp", "viscosityScale_Position", "viscosityScale", "viscosityScaleInput", "viscosityScaleInputMax", "windSelfShadow"]
	nodeLeafPlugs = ["blobbyRadiusScale", "bounceRandomize", "bounceScale", "bounceScaleInput", "bounceScaleInputMax", "cacheableAttributes", "collideStrengthScale", "collideStrengthScaleInput", "collideStrengthScaleInputMax", "collideWidthScale", "color", "colorBlue", "colorGreen", "colorInput", "colorInputMax", "colorPerVertex", "colorRandomize", "colorRed", "computeRotation", "drag", "emissionOverlapPruning", "enableSPH", "frictionRandomize", "frictionScale", "frictionScaleInput", "frictionScaleInputMax", "ignoreSolverGravity", "ignoreSolverWind", "incandescence", "incandescenceInput", "incandescenceInputMax", "incandescencePerVertex", "incandescenceRandomize", "incompressibility", "inputAttract", "inputAttractDamp", "internalBounceRamp", "internalCollideStrengthRamp", "internalColorRamp", "internalFieldScaleRamp", "internalFrictionRamp", "internalIncandescenceRamp", "internalMassRamp", "internalOpacityRamp", "internalRadiusRamp", "internalStickinessRamp", "internalSurfaceTensionRamp", "internalViscosityRamp", "massScale", "massScaleInput", "massScaleInputMax", "massScaleRandomize", "maxTriangleResolution", "meshMethod", "meshSmoothingIterations", "meshTriangleSize", "motionStreak", "numSubdivisions", "opacity", "opacityPerVertex", "opacityScale", "opacityScaleInput", "opacityScaleInputMax", "opacityScaleRandomize", "outMesh", "parallelSPH", "pointFieldScale", "pointFieldScaleInput", "pointFieldScaleInputMax", "postCacheRampEval", "radius", "radiusScale", "radiusScaleInput", "radiusScaleInputMax", "radiusScaleRandomize", "radiusScaleSPH", "recomputePairsSPH", "restDensity", "rotationDamp", "rotationFriction", "scalingRelation", "selfCollideWidthScale", "solverDisplay", "stickinessRandomize", "stickinessScale", "stickinessScaleInput", "stickinessScaleInputMax", "surfaceTension", "surfaceTensionScale", "surfaceTensionScaleInput", "surfaceTensionScaleInputMax", "threshold", "useGradientNormals", "uvwPerVertex", "velocityPerVertex", "viscosity", "viscosityScale", "viscosityScaleInput", "viscosityScaleInputMax", "windSelfShadow"]
	pass
