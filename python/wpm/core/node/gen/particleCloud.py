...
class ParticleCloud(ShadingDependNode):
	...
	nodeLeafClassAttrs = ["blobMapB", "blobMapG", "blobMapR", "blobMap", "colorB", "colorG", "colorR", "color", "density", "diffuseCoeff", "filterRadius", "glowIntensity", "incandescenceB", "incandescenceG", "incandescenceR", "incandescence", "lightAmbient", "lightBlindData", "lightDiffuse", "lightDirectionX", "lightDirectionY", "lightDirectionZ", "lightDirection", "lightIntensityB", "lightIntensityG", "lightIntensityR", "lightIntensity", "lightShadowFraction", "lightSpecular", "preShadowIntensity", "lightDataArray", "noise", "noiseAnimRate", "noiseAspect", "noiseFreq", "normalCameraX", "normalCameraY", "normalCameraZ", "normalCamera", "outColorB", "outColorG", "outColorR", "outColor", "outGlowColorB", "outGlowColorG", "outGlowColorR", "outGlowColor", "outParticleEmissionB", "outParticleEmissionG", "outParticleEmissionR", "outParticleEmission", "outTransparencyB", "outTransparencyG", "outTransparencyR", "outTransparency", "particleEmissionB", "particleEmissionG", "particleEmissionR", "particleEmission", "particleOrder", "particleWeight", "pointObjX", "pointObjY", "pointObjZ", "pointObj", "rayDepth", "renderState", "roundness", "solidCoreSize", "surfaceColorB", "surfaceColorG", "surfaceColorR", "surfaceColor", "surfaceShadingShadow", "translucence", "translucenceCoeff", "transparencyB", "transparencyG", "transparencyR", "transparency"]
	nodeLeafPlugs = ["blobMap", "color", "density", "diffuseCoeff", "filterRadius", "glowIntensity", "incandescence", "lightDataArray", "noise", "noiseAnimRate", "noiseAspect", "noiseFreq", "normalCamera", "outColor", "outGlowColor", "outParticleEmission", "outTransparency", "particleEmission", "particleOrder", "particleWeight", "pointObj", "rayDepth", "renderState", "roundness", "solidCoreSize", "surfaceColor", "surfaceShadingShadow", "translucence", "translucenceCoeff", "transparency"]
	pass
