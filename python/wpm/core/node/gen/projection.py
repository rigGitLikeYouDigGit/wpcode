...
class Projection(Texture3d):
	...
	nodeLeafClassAttrs = ["amplitudeX", "amplitudeY", "angWts", "camAngX", "camAngY", "camAngZ", "camAg", "camPsX", "camPsY", "camPsZ", "camPos", "defaultTransparencyB", "defaultTransparencyG", "defaultTransparencyR", "defaultTransparency", "depWts", "depthMax", "depthMin", "depth", "fitFill", "fitType", "imageB", "imageG", "imageR", "image", "infoBits", "linkedCamera", "normalCameraX", "normalCameraY", "normalCameraZ", "normalCamera", "outTransparencyB", "outTransparencyG", "outTransparencyR", "outTransparency", "passTr", "projType", "ratio", "refPointCameraX", "refPointCameraY", "refPointCameraZ", "refPointCamera", "refPointObjX", "refPointObjY", "refPointObjZ", "refPointObj", "ripplesX", "ripplesY", "ripplesZ", "ripples", "srfNormalX", "srfNormalY", "srfNormalZ", "srfNormal", "tangentUx", "tangentUy", "tangentUz", "tangentUCamera", "tangentVx", "tangentVy", "tangentVz", "tangentVCamera", "transparencyB", "transparencyG", "transparencyR", "transparency", "transparencyGainB", "transparencyGainG", "transparencyGainR", "transparencyGain", "transparencyOffsetB", "transparencyOffsetG", "transparencyOffsetR", "transparencyOffset", "uAngle", "uCoord", "vCoord", "uvCoord", "uvFilterSizeX", "uvFilterSizeY", "uvFilterSize", "vAngle", "vertexCameraOneX", "vertexCameraOneY", "vertexCameraOneZ", "vertexCameraOne", "vertexCameraThreeX", "vertexCameraThreeY", "vertexCameraThreeZ", "vertexCameraThree", "vertexCameraTwoX", "vertexCameraTwoY", "vertexCameraTwoZ", "vertexCameraTwo", "vertexUvOneU", "vertexUvOneV", "vertexUvOne", "vertexUvThreeU", "vertexUvThreeV", "vertexUvThree", "vertexUvTwoU", "vertexUvTwoV", "vertexUvTwo", "xPixelAngle"]
	nodeLeafPlugs = ["amplitudeX", "amplitudeY", "angWts", "camAg", "camPos", "defaultTransparency", "depWts", "depth", "fitFill", "fitType", "image", "infoBits", "linkedCamera", "normalCamera", "outTransparency", "passTr", "projType", "ratio", "refPointCamera", "refPointObj", "ripples", "srfNormal", "tangentUCamera", "tangentVCamera", "transparency", "transparencyGain", "transparencyOffset", "uAngle", "uvCoord", "uvFilterSize", "vAngle", "vertexCameraOne", "vertexCameraThree", "vertexCameraTwo", "vertexUvOne", "vertexUvThree", "vertexUvTwo", "xPixelAngle"]
	pass
