...
class DagNode(Entity):
	...
	nodeLeafClassAttrs = ["boundingBoxMaxX", "boundingBoxMaxY", "boundingBoxMaxZ", "boundingBoxMax", "boundingBoxMinX", "boundingBoxMinY", "boundingBoxMinZ", "boundingBoxMin", "boundingBoxSizeX", "boundingBoxSizeY", "boundingBoxSizeZ", "boundingBoxSize", "boundingBox", "boundingBoxCenterX", "boundingBoxCenterY", "boundingBoxCenterZ", "center", "hideOnPlayback", "overrideColor", "overrideColorA", "overrideColorRGB", "overrideDisplayType", "overrideEnabled", "overrideLevelOfDetail", "overridePlayback", "overrideRGBColors", "overrideShading", "overrideTexturing", "overrideVisibility", "drawOverride", "ghostColorPostB", "ghostColorPostG", "ghostColorPostR", "ghostColorPost", "ghostColorPreB", "ghostColorPreG", "ghostColorPreR", "ghostColorPre", "ghostPostFrames", "ghostPreFrames", "ghostsStep", "ghostCustomSteps", "ghostDriver", "ghostFrames", "ghostFarOpacity", "ghostNearOpacity", "ghostOpacityRange", "ghostUseDriver", "ghosting", "ghostingMode", "hiddenInOutliner", "objectGrpColor", "objectGrpCompList", "objectGroups", "instObjGroups", "intermediateObject", "inverseMatrix", "lodVisibility", "matrix", "objectColor", "objectColorB", "objectColorG", "objectColorR", "objectColorRGB", "objectGroupId", "outlinerColorB", "outlinerColorG", "outlinerColorR", "outlinerColor", "overrideColorB", "overrideColorG", "overrideColorR", "parentInverseMatrix", "parentMatrix", "identification", "layerOverrideColor", "layerRenderable", "renderInfo", "renderLayerColor", "renderLayerId", "renderLayerRenderable", "renderLayerInfo", "selectionChildHighlighting", "template", "useObjectColor", "useOutlinerColor", "visibility", "wireColorB", "wireColorG", "wireColorR", "wireColorRGB", "worldInverseMatrix", "worldMatrix"]
	nodeLeafPlugs = ["boundingBox", "center", "drawOverride", "ghostColorPost", "ghostColorPre", "ghostCustomSteps", "ghostDriver", "ghostFrames", "ghostOpacityRange", "ghostUseDriver", "ghosting", "ghostingMode", "hiddenInOutliner", "instObjGroups", "intermediateObject", "inverseMatrix", "lodVisibility", "matrix", "objectColor", "objectColorRGB", "outlinerColor", "parentInverseMatrix", "parentMatrix", "renderInfo", "renderLayerInfo", "selectionChildHighlighting", "template", "useObjectColor", "useOutlinerColor", "visibility", "wireColorRGB", "worldInverseMatrix", "worldMatrix"]
	pass
