...
if T.TYPE_CHECKING:
	...
	SnapshotShape = Catalogue.SnapshotShape
else:
...
class MotionTrailShape(SnapshotShape):
	...
	nodeLeafClassAttrs = ["activeKeyframeColorB", "activeKeyframeColorG", "activeKeyframeColorR", "activeKeyframeColor", "beadColorB", "beadColorG", "beadColorR", "beadColor", "extraKeyframeColorB", "extraKeyframeColorG", "extraKeyframeColorR", "extraKeyframeColor", "extraKeyframeTimes", "extraTrailColorB", "extraTrailColorG", "extraTrailColorR", "extraTrailColor", "fadeInoutFrames", "frameMarkerColorB", "frameMarkerColorG", "frameMarkerColorR", "frameMarkerColor", "frameMarkerSize", "increment", "keyframeColorB", "keyframeColorG", "keyframeColorR", "keyframeColor", "keyframeFlags", "keyframeSize", "keyframeTimes", "localPositionX", "localPositionY", "localPositionZ", "localPosition", "modifyKeys", "pinned", "postFrame", "preFrame", "showExtraKeys", "showFrameMarkerFrames", "showFrameMarkers", "showInBead", "showInTangent", "showOutBead", "showOutTangent", "startTime", "txValue", "tyValue", "tzValue", "tangentPoints", "trailColorB", "trailColorG", "trailColorR", "trailColor", "trailDrawMode", "trailThickness", "transformToMove", "xrayDraw"]
	nodeLeafPlugs = ["activeKeyframeColor", "beadColor", "extraKeyframeColor", "extraKeyframeTimes", "extraTrailColor", "fadeInoutFrames", "frameMarkerColor", "frameMarkerSize", "increment", "keyframeColor", "keyframeFlags", "keyframeSize", "keyframeTimes", "localPosition", "modifyKeys", "pinned", "postFrame", "preFrame", "showExtraKeys", "showFrameMarkerFrames", "showFrameMarkers", "showInBead", "showInTangent", "showOutBead", "showOutTangent", "startTime", "tangentPoints", "trailColor", "trailDrawMode", "trailThickness", "transformToMove", "xrayDraw"]
	pass
