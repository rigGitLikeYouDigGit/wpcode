...
class Particle(DeformableShape):
	...
	nodeLeafClassAttrs = ["acceleration", "acceleration0", "age", "age0", "ageCache", "agesLastDone", "auxiliariesOwned", "birthTime", "birthTime0", "birthTimeCache", "cacheData", "cacheWidth", "cachedPosition", "cachedTime", "cachedVelocity", "cachedWorldCentroidX", "cachedWorldCentroidY", "cachedWorldCentroidZ", "cachedWorldCentroid", "cachedWorldPosition", "cachedWorldVelocity", "centroidX", "centroidY", "centroidZ", "centroid", "collisionConnections", "collisionFriction", "collisionGeometry", "collisionOffset", "collisionResilience", "collisionData", "collisionEvents", "collisionRecords", "collisions", "computingCount", "connectionsToMe", "conserve", "count", "currentParticle", "currentSceneTime", "currentTime", "currentTimeSave", "death", "debugDraw", "deformedPosition", "depthSort", "dieOnEmissionVolumeExit", "diedLastTime", "disableCloudAxis", "doAge", "doDynamics", "doEmission", "dynamicsWeight", "emission", "emissionInWorld", "emitterConnections", "emitterDataDeltaTime", "emitterDataPosition", "emitterDataVelocity", "emitterData", "emitterId", "emitterId0", "enforceCountFromHistory", "evaluationTime", "eventCount", "eventDie", "eventEmit", "eventName", "eventNameCount", "eventProc", "eventRandStateX", "eventRandStateY", "eventRandStateZ", "eventRandState", "eventRandom", "eventSeed", "eventSplit", "eventSpread", "eventTarget", "eventTest", "eventValid", "executeCreationExpression", "executeRuntimeAfterDynamicsExpression", "executeRuntimeBeforeDynamicsExpression", "expressionsAfterDynamics", "fieldConnections", "fieldDataDeltaTime", "fieldDataMass", "fieldDataPosition", "fieldDataVelocity", "fieldData", "finalLifespanPP", "force", "forceDynamics", "forceEmission", "forcesInWorld", "frame", "generalSeed", "goalActive", "goalGeometry", "goalSmoothness", "goalUvSetName", "goalWeight", "idCache", "idIndex", "sortedId", "idMapping", "inheritColor", "inheritFactor", "input", "inputForce", "inputGeometry", "inputGeometryPoints", "inputGeometrySpace", "instanceAttributeMapping", "instancePointData", "instanceData", "internalCreationExpression", "internalRuntimeAfterDynamicsExpression", "internalRuntimeBeforeDynamicsExpression", "internalRuntimeExpression", "isDynamic", "isFull", "lastCachedPosition", "lastPosition", "lastSceneTime", "lastTimeEvaluated", "lastTotalEventCount", "lastVelocity", "lastWorldMatrix", "lastWorldPosition", "lastWorldVelocity", "levelOfDetail", "lifespanMode", "lifespanRandom", "mass", "mass0", "massCache", "maxCount", "netEmittedLastTime", "newFileFormat", "newParticles", "nextId", "nextId0", "normalizeVelocity", "numberOfEvents", "output", "ownerPPFieldData", "parentMatrixDirty", "particleId", "particleId0", "particleRenderType", "position", "position0", "ppFieldData", "rampAcceleration", "rampPosition", "rampVelocity", "randStateX", "randStateY", "randStateZ", "randState", "samplerPerParticleData", "sceneTimeStepSize", "seed", "shapeNameMsg", "startEmittedIndex", "startFrame", "startTime", "startupCacheFrame", "startupCachePath", "targetGeometry", "targetGeometrySpace", "targetGeometryWorldMatrix", "time", "timeLastComputed", "timeStepSize", "totalEventCount", "traceDepth", "useCustomCache", "useStartupCache", "velocity", "velocity0", "worldCentroidX", "worldCentroidY", "worldCentroidZ", "worldCentroid", "worldPosition", "worldVelocity", "worldVelocityInObjectSpace"]
	nodeLeafPlugs = ["acceleration", "acceleration0", "age", "age0", "ageCache", "agesLastDone", "auxiliariesOwned", "birthTime", "birthTime0", "birthTimeCache", "cacheData", "cacheWidth", "cachedPosition", "cachedTime", "cachedVelocity", "cachedWorldCentroid", "cachedWorldPosition", "cachedWorldVelocity", "centroid", "collisionConnections", "collisionData", "collisionEvents", "collisionRecords", "collisions", "computingCount", "connectionsToMe", "conserve", "count", "currentParticle", "currentSceneTime", "currentTime", "currentTimeSave", "death", "debugDraw", "deformedPosition", "depthSort", "dieOnEmissionVolumeExit", "diedLastTime", "disableCloudAxis", "doAge", "doDynamics", "doEmission", "dynamicsWeight", "emission", "emissionInWorld", "emitterConnections", "emitterData", "emitterId", "emitterId0", "enforceCountFromHistory", "evaluationTime", "eventCount", "eventDie", "eventEmit", "eventName", "eventNameCount", "eventProc", "eventRandState", "eventRandom", "eventSeed", "eventSplit", "eventSpread", "eventTarget", "eventTest", "eventValid", "executeCreationExpression", "executeRuntimeAfterDynamicsExpression", "executeRuntimeBeforeDynamicsExpression", "expressionsAfterDynamics", "fieldConnections", "fieldData", "finalLifespanPP", "force", "forceDynamics", "forceEmission", "forcesInWorld", "frame", "generalSeed", "goalActive", "goalGeometry", "goalSmoothness", "goalUvSetName", "goalWeight", "idCache", "idMapping", "inheritColor", "inheritFactor", "input", "inputForce", "inputGeometry", "inputGeometryPoints", "inputGeometrySpace", "instanceData", "internalCreationExpression", "internalRuntimeAfterDynamicsExpression", "internalRuntimeBeforeDynamicsExpression", "internalRuntimeExpression", "isDynamic", "isFull", "lastCachedPosition", "lastPosition", "lastSceneTime", "lastTimeEvaluated", "lastTotalEventCount", "lastVelocity", "lastWorldMatrix", "lastWorldPosition", "lastWorldVelocity", "levelOfDetail", "lifespanMode", "lifespanRandom", "mass", "mass0", "massCache", "maxCount", "netEmittedLastTime", "newFileFormat", "newParticles", "nextId", "nextId0", "normalizeVelocity", "numberOfEvents", "output", "ownerPPFieldData", "parentMatrixDirty", "particleId", "particleId0", "particleRenderType", "position", "position0", "ppFieldData", "rampAcceleration", "rampPosition", "rampVelocity", "randState", "samplerPerParticleData", "sceneTimeStepSize", "seed", "shapeNameMsg", "startEmittedIndex", "startFrame", "startTime", "startupCacheFrame", "startupCachePath", "targetGeometry", "targetGeometrySpace", "targetGeometryWorldMatrix", "time", "timeLastComputed", "timeStepSize", "totalEventCount", "traceDepth", "useCustomCache", "useStartupCache", "velocity", "velocity0", "worldCentroid", "worldPosition", "worldVelocity", "worldVelocityInObjectSpace"]
	pass
