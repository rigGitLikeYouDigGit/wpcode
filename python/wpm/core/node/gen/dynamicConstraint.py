...
class DynamicConstraint(Shape):
	...
	nodeLeafClassAttrs = ["bend", "bendBreakAngle", "bendStrength", "collide", "collideWidthScale", "componentIds", "componentRelation", "connectWithinComponent", "connectionDensity", "connectionDensityRange_FloatValue", "connectionDensityRange_Interp", "connectionDensityRange_Position", "connectionDensityRange", "connectionMethod", "connectionUpdate", "constraintMethod", "constraintRelation", "currentTime", "damp", "displayConnections", "dropoff", "dropoffDistance", "enable", "evalCurrent", "evalStart", "excludeCollisions", "force", "friction", "glueStrength", "glueStrengthScale", "isDynamic", "iterations", "localCollide", "maxDistance", "maxIterations", "minIterations", "motionDrag", "restLength", "restLengthMethod", "restLengthScale", "singleSided", "strength", "strengthDropoff_FloatValue", "strengthDropoff_Interp", "strengthDropoff_Position", "strengthDropoff", "tangentStrength"]
	nodeLeafPlugs = ["bend", "bendBreakAngle", "bendStrength", "collide", "collideWidthScale", "componentIds", "componentRelation", "connectWithinComponent", "connectionDensity", "connectionDensityRange", "connectionMethod", "connectionUpdate", "constraintMethod", "constraintRelation", "currentTime", "damp", "displayConnections", "dropoff", "dropoffDistance", "enable", "evalCurrent", "evalStart", "excludeCollisions", "force", "friction", "glueStrength", "glueStrengthScale", "isDynamic", "iterations", "localCollide", "maxDistance", "maxIterations", "minIterations", "motionDrag", "restLength", "restLengthMethod", "restLengthScale", "singleSided", "strength", "strengthDropoff", "tangentStrength"]
	pass
