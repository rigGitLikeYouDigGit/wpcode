...
class AimConstraint(Constraint):
	...
	nodeLeafClassAttrs = ["aimVectorX", "aimVectorY", "aimVectorZ", "aimVector", "constraintJointOrientX", "constraintJointOrientY", "constraintJointOrientZ", "constraintJointOrient", "constraintParentInverseMatrix", "constraintRotateX", "constraintRotateY", "constraintRotateZ", "constraintRotate", "constraintRotateOrder", "constraintRotatePivotX", "constraintRotatePivotY", "constraintRotatePivotZ", "constraintRotatePivot", "constraintRotateTranslateX", "constraintRotateTranslateY", "constraintRotateTranslateZ", "constraintRotateTranslate", "constraintTranslateX", "constraintTranslateY", "constraintTranslateZ", "constraintTranslate", "constraintVectorX", "constraintVectorY", "constraintVectorZ", "constraintVector", "inverseScaleX", "inverseScaleY", "inverseScaleZ", "inverseScale", "offsetX", "offsetY", "offsetZ", "offset", "restRotateX", "restRotateY", "restRotateZ", "restRotate", "scaleCompensate", "targetParentMatrix", "targetRotatePivotX", "targetRotatePivotY", "targetRotatePivotZ", "targetRotatePivot", "targetRotateTranslateX", "targetRotateTranslateY", "targetRotateTranslateZ", "targetRotateTranslate", "targetTranslateX", "targetTranslateY", "targetTranslateZ", "targetTranslate", "targetWeight", "target", "upVectorX", "upVectorY", "upVectorZ", "upVector", "useOldOffsetCalculation", "worldUpMatrix", "worldUpType", "worldUpVectorX", "worldUpVectorY", "worldUpVectorZ", "worldUpVector"]
	nodeLeafPlugs = ["aimVector", "constraintJointOrient", "constraintParentInverseMatrix", "constraintRotate", "constraintRotateOrder", "constraintRotatePivot", "constraintRotateTranslate", "constraintTranslate", "constraintVector", "inverseScale", "offset", "restRotate", "scaleCompensate", "target", "upVector", "useOldOffsetCalculation", "worldUpMatrix", "worldUpType", "worldUpVector"]
	pass
