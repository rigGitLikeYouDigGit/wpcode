...
class HardwareRenderingGlobals(_BASE_):
	...
	nodeLeafClassAttrs = ["alphaCutPrepass", "lightingMode", "objectTypeFilterNameArray", "objectTypeFilterValueArray", "pluginObjectTypeFilterNameArray", "pluginObjectTypeFilterValueArray", "renderMode", "batchRenderControls", "binMembership", "bloomAmount", "bloomEnable", "bloomFilter", "bloomFilterAux", "bloomFilterRadius", "bloomThreshold", "bumpBakeResolution", "colorBakeResolution", "compressSharedVertexData", "consolidateWorld", "currentRendererName", "customUVBorderColorB", "customUVBorderColorG", "customUVBorderColorR", "customUVBorderColor", "enableTextureMaxRes", "floatingPointRTEnable", "floatingPointRTFormat", "gammaCorrectionEnable", "gammaValue", "holdOutDetailMode", "holdOutMode", "hwFogAlpha", "hwFogColorB", "hwFogColorG", "hwFogColorR", "hwFogColor", "hwFogDensity", "hwFogEnable", "hwFogEnd", "hwFogFalloff", "hwFogStart", "hwInstancing", "isCustomUVBorderColor", "lineAAEnable", "maxHardwareLights", "motionBlurAtlasSizeX", "motionBlurAtlasSizeY", "motionBlurAtlasSize", "motionBlurCurved", "motionBlurEnable", "motionBlurFadeAmount", "motionBlurFadeEmphasis", "motionBlurFadeFilter", "motionBlurFadeTintB", "motionBlurFadeTintG", "motionBlurFadeTintR", "motionBlurFadeTint", "motionBlurFadeTintA", "motionBlurMultiframeChartSizeX", "motionBlurMultiframeChartSizeY", "motionBlurMultiframeChartSize", "motionBlurMultiframeEnable", "motionBlurSampleCount", "motionBlurShutterOpenFraction", "motionBlurType", "multiSampleCount", "multiSampleEnable", "multiSampleQuality", "quadDrawAlwaysOnTop", "quadDrawOverrideColorB", "quadDrawOverrideColorG", "quadDrawOverrideColorR", "quadDrawOverrideColor", "quadDrawOverrideTransparency", "renderDepthOfField", "renderOverrideName", "singleSidedLighting", "ssaoAmount", "ssaoEnable", "ssaoFilter", "ssaoFilterRadius", "ssaoRadius", "ssaoSamples", "textureAutoMaxResolution", "textureMaxResMode", "textureMaxResolution", "transparencyAlgorithm", "transparencyQuality", "transparentShadow", "useMaximumHardwareLights", "vertexAnimationCache", "xrayJointDisplay", "xrayMode"]
	nodeLeafPlugs = ["alphaCutPrepass", "batchRenderControls", "binMembership", "bloomAmount", "bloomEnable", "bloomFilter", "bloomFilterAux", "bloomFilterRadius", "bloomThreshold", "bumpBakeResolution", "colorBakeResolution", "compressSharedVertexData", "consolidateWorld", "currentRendererName", "customUVBorderColor", "enableTextureMaxRes", "floatingPointRTEnable", "floatingPointRTFormat", "gammaCorrectionEnable", "gammaValue", "holdOutDetailMode", "holdOutMode", "hwFogAlpha", "hwFogColor", "hwFogDensity", "hwFogEnable", "hwFogEnd", "hwFogFalloff", "hwFogStart", "hwInstancing", "isCustomUVBorderColor", "lineAAEnable", "maxHardwareLights", "motionBlurAtlasSize", "motionBlurCurved", "motionBlurEnable", "motionBlurFadeAmount", "motionBlurFadeEmphasis", "motionBlurFadeFilter", "motionBlurFadeTint", "motionBlurFadeTintA", "motionBlurMultiframeChartSize", "motionBlurMultiframeEnable", "motionBlurSampleCount", "motionBlurShutterOpenFraction", "motionBlurType", "multiSampleCount", "multiSampleEnable", "multiSampleQuality", "quadDrawAlwaysOnTop", "quadDrawOverrideColor", "quadDrawOverrideTransparency", "renderDepthOfField", "renderOverrideName", "singleSidedLighting", "ssaoAmount", "ssaoEnable", "ssaoFilter", "ssaoFilterRadius", "ssaoRadius", "ssaoSamples", "textureAutoMaxResolution", "textureMaxResMode", "textureMaxResolution", "transparencyAlgorithm", "transparencyQuality", "transparentShadow", "useMaximumHardwareLights", "vertexAnimationCache", "xrayJointDisplay", "xrayMode"]
	pass
