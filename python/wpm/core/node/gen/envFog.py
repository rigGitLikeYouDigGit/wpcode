...
class EnvFog(LightFog):
	...
	nodeLeafClassAttrs = ["airColorB", "airColorG", "airColorR", "airColor", "airDecay", "airDensity", "airLightScatter", "airMaxHeight", "airMinHeight", "airOpacityB", "airOpacityG", "airOpacityR", "airOpacity", "blendRange", "distanceClipPlanes", "endDistance", "fogAxis", "fogColorB", "fogColorG", "fogColorR", "fogColor", "fogDecay", "fogDensity", "fogFarDistance", "fogLightScatter", "fogMaxHeight", "fogMinHeight", "fogNearDistance", "fogOpacityB", "fogOpacityG", "fogOpacityR", "fogOpacity", "fogType", "layer", "matrixEyeToWorld", "maxHeight", "minHeight", "physicalFog", "planetRadius", "pointCameraX", "pointCameraY", "pointCameraZ", "pointCamera", "pointWorldX", "pointWorldY", "pointWorldZ", "pointWorld", "rayDirectionX", "rayDirectionY", "rayDirectionZ", "rayDirection", "saturationDistance", "startDistance", "sunAzimuth", "sunColorB", "sunColorG", "sunColorR", "sunColor", "sunElevation", "sunIntensity", "useDistance", "useHeight", "useLayer", "waterColorB", "waterColorG", "waterColorR", "waterColor", "waterDensity", "waterDepth", "waterLevel", "waterLightDecay", "waterLightScatter", "waterOpacityB", "waterOpacityG", "waterOpacityR", "waterOpacity"]
	nodeLeafPlugs = ["airColor", "airDecay", "airDensity", "airLightScatter", "airMaxHeight", "airMinHeight", "airOpacity", "blendRange", "distanceClipPlanes", "endDistance", "fogAxis", "fogColor", "fogDecay", "fogDensity", "fogFarDistance", "fogLightScatter", "fogMaxHeight", "fogMinHeight", "fogNearDistance", "fogOpacity", "fogType", "layer", "matrixEyeToWorld", "maxHeight", "minHeight", "physicalFog", "planetRadius", "pointCamera", "pointWorld", "rayDirection", "saturationDistance", "startDistance", "sunAzimuth", "sunColor", "sunElevation", "sunIntensity", "useDistance", "useHeight", "useLayer", "waterColor", "waterDensity", "waterDepth", "waterLevel", "waterLightDecay", "waterLightScatter", "waterOpacity"]
	pass
