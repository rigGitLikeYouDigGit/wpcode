...
class RigidBody(Shape):
	...
	nodeLeafClassAttrs = ["active", "allowDisconnection", "applyForceAt", "autoInit", "bakeSimulationIndex", "bounciness", "cacheData", "cacheDirtyArray", "cachedFrameCount", "centerOfMassX", "centerOfMassY", "centerOfMassZ", "centerOfMass", "choice", "collisionLayer", "collisionRecords", "collisions", "contactCount", "contactName", "contactX", "contactY", "contactZ", "contactPosition", "currentTime", "damping", "dataCache", "debugDraw", "dynamicFriction", "fieldConnections", "deltaTime", "fieldDataMass", "fieldDataPosition", "fieldDataVelocity", "fieldData", "firstCachedFrame", "forceX", "forceY", "forceZ", "force", "outputForce", "outputTorque", "generalForce", "ignore", "impulseX", "impulseY", "impulseZ", "impulse", "impulsePositionX", "impulsePositionY", "impulsePositionZ", "impulsePosition", "initialOrientationX", "initialOrientationY", "initialOrientationZ", "initialOrientation", "initialPositionX", "initialPositionY", "initialPositionZ", "initialPosition", "initialSpinX", "initialSpinY", "initialSpinZ", "initialSpin", "initialVelocityX", "initialVelocityY", "initialVelocityZ", "initialVelocity", "inputForce", "inputForceType", "inputGeometryCnt", "inputGeometryMsg", "interpenetrateWith", "isKeyframed", "isKinematic", "isParented", "lastCachedFrame", "lastPositionX", "lastPositionY", "lastPositionZ", "lastPosition", "lastRotationX", "lastRotationY", "lastRotationZ", "lastRotation", "lastSceneTime", "lockCenterOfMass", "mass", "particleCollision", "rigidWorldMatrix", "runUpCache", "shapeChanged", "solverId", "spinX", "spinY", "spinZ", "spin", "spinImpulseX", "spinImpulseY", "spinImpulseZ", "spinImpulse", "standIn", "staticFriction", "tessellationFactor", "torqueX", "torqueY", "torqueZ", "torque", "velocityX", "velocityY", "velocityZ", "velocity", "volume"]
	nodeLeafPlugs = ["active", "allowDisconnection", "applyForceAt", "autoInit", "bakeSimulationIndex", "bounciness", "cacheData", "cacheDirtyArray", "cachedFrameCount", "centerOfMass", "choice", "collisionLayer", "collisionRecords", "collisions", "contactCount", "contactName", "contactPosition", "currentTime", "damping", "dataCache", "debugDraw", "dynamicFriction", "fieldConnections", "fieldData", "firstCachedFrame", "force", "generalForce", "ignore", "impulse", "impulsePosition", "initialOrientation", "initialPosition", "initialSpin", "initialVelocity", "inputForce", "inputForceType", "inputGeometryCnt", "inputGeometryMsg", "interpenetrateWith", "isKeyframed", "isKinematic", "isParented", "lastCachedFrame", "lastPosition", "lastRotation", "lastSceneTime", "lockCenterOfMass", "mass", "particleCollision", "rigidWorldMatrix", "runUpCache", "shapeChanged", "solverId", "spin", "spinImpulse", "standIn", "staticFriction", "tessellationFactor", "torque", "velocity", "volume"]
	pass
