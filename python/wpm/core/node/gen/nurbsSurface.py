...
class NurbsSurface(SurfaceShape):
	...
	nodeLeafClassAttrs = ["basicTessellationType", "cached", "chordHeight", "chordHeightRatio", "create", "curvatureTolerance", "curvePrecision", "curvePrecisionShaded", "degreeU", "degreeV", "degreeUV", "dispCV", "dispEP", "dispGeometry", "dispHull", "dispOrigin", "dispSF", "displayRenderTessellation", "divisionsU", "divisionsV", "edgeSwap", "explicitTessellationAttributes", "fixTextureWarp", "formU", "formV", "gridDivisionPerSpanU", "gridDivisionPerSpanV", "header", "inPlace", "local", "maxValueU", "minValueU", "minMaxRangeU", "maxValueV", "minValueV", "minMaxRangeV", "minScreen", "modeU", "modeV", "normalsDisplayScale", "numberU", "numberV", "objSpaceChordHeight", "patchUVIds", "renderTriangleCount", "selCVDisp", "simplifyMode", "simplifyU", "simplifyV", "smoothEdge", "smoothEdgeRatio", "spansU", "spansV", "spansUV", "trimFace", "tweakSizeU", "tweakSizeV", "uDivisionsFactor", "useChordHeight", "useChordHeightRatio", "useMinScreen", "vDivisionsFactor", "worldSpace"]
	nodeLeafPlugs = ["basicTessellationType", "cached", "chordHeight", "chordHeightRatio", "create", "curvatureTolerance", "curvePrecision", "curvePrecisionShaded", "degreeUV", "dispCV", "dispEP", "dispGeometry", "dispHull", "dispOrigin", "dispSF", "displayRenderTessellation", "divisionsU", "divisionsV", "edgeSwap", "explicitTessellationAttributes", "fixTextureWarp", "formU", "formV", "gridDivisionPerSpanU", "gridDivisionPerSpanV", "header", "inPlace", "local", "minMaxRangeU", "minMaxRangeV", "minScreen", "modeU", "modeV", "normalsDisplayScale", "numberU", "numberV", "objSpaceChordHeight", "patchUVIds", "renderTriangleCount", "selCVDisp", "simplifyMode", "simplifyU", "simplifyV", "smoothEdge", "smoothEdgeRatio", "spansUV", "trimFace", "tweakSizeU", "tweakSizeV", "uDivisionsFactor", "useChordHeight", "useChordHeightRatio", "useMinScreen", "vDivisionsFactor", "worldSpace"]
	pass
