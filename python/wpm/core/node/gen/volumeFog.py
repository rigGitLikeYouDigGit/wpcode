...
class VolumeFog(ShadingDependNode):
	...
	nodeLeafClassAttrs = ["axialDropoff", "colorB", "colorG", "colorR", "color", "colorRamp_ColorB", "colorRamp_ColorG", "colorRamp_ColorR", "colorRamp_Color", "colorRamp_Interp", "colorRamp_Position", "colorRamp", "colorRampInput", "density", "densityMode", "dropoffMethod", "dropoffShape", "dropoffSubtract", "edgeDropoff", "farPointObjectX", "farPointObjectY", "farPointObjectZ", "farPointObj", "farPointWorldX", "farPointWorldY", "farPointWorldZ", "farPointWorld", "glowIntensity", "illuminated", "incandescenceB", "incandescenceG", "incandescenceR", "incandescence", "lightAmbient", "lightBlindData", "lightDiffuse", "lightDirectionX", "lightDirectionY", "lightDirectionZ", "lightDirection", "lightIntensityB", "lightIntensityG", "lightIntensityR", "lightIntensity", "lightShadowFraction", "lightSpecular", "preShadowIntensity", "lightDataArray", "lightScatter", "matrixWorldToEye", "matteOpacity", "matteOpacityMode", "outColorB", "outColorG", "outColorR", "outColor", "outGlowColorB", "outGlowColorG", "outGlowColorR", "outGlowColor", "outMatteOpacityB", "outMatteOpacityG", "outMatteOpacityR", "outMatteOpacity", "outTransparencyB", "outTransparencyG", "outTransparencyR", "outTransparency", "pointObjX", "pointObjY", "pointObjZ", "pointObj", "pointWorldX", "pointWorldY", "pointWorldZ", "pointWorld", "rayDirectionX", "rayDirectionY", "rayDirectionZ", "rayDirection", "transparencyB", "transparencyG", "transparencyR", "transparency"]
	nodeLeafPlugs = ["axialDropoff", "color", "colorRamp", "colorRampInput", "density", "densityMode", "dropoffMethod", "dropoffShape", "dropoffSubtract", "edgeDropoff", "farPointObj", "farPointWorld", "glowIntensity", "illuminated", "incandescence", "lightDataArray", "lightScatter", "matrixWorldToEye", "matteOpacity", "matteOpacityMode", "outColor", "outGlowColor", "outMatteOpacity", "outTransparency", "pointObj", "pointWorld", "rayDirection", "transparency"]
	pass
