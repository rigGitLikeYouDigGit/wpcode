...
// editing to add support for Eigen types
/* code taken from https://github.com/lohedges/aabbcc/tree/master
*/
#include <Eigen/Dense>
//namespace Eigen {
...
//    using Vector3f = Matrix<float, 3, 1, 0, -1, 1>;
//}
...
namespace aabb
{
    ...
    public:
         ...
         */
        AABB(const Eigen::Vector3f&, const Eigen::Vector3f&);
