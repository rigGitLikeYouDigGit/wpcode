...
public:
	...
	// attribute MObjects
	// inputs for points
	static MObject aStPoints;
		static MObject aStPointMatrix;
		static MObject aStPointBalance;
	// inputs for curves
	static MObject aStEdges;
		static MObject aStEdgeCurve;
		static MObject aStEdgeUpCurve;
		static MObject aStEdgeBalance;

	// jesus take the wheel
	static MObject aStOps;
		static MObject aOpType; // enum for the different available types of strataOp
